...
<figure class="book-figure">
  <img src="../../../../en/book/assets/figures/fig-06-family-health-four-things.svg" alt="Family health management: manage four things first">
</figure>
...
资料更复杂的家庭，可以再扩展到 [Family Health Record And Chronic Marker Log](../../handbook/templates/family-health-record.md)。如果有血压、血糖/A1C、胆固醇和甘油三酯、尿酸、肾功能等长期指标，再用 [Chronic Marker Log](../../handbook/templates/family-health-record.md#_2-chronic-marker-log) 单独看趋势。
...
准备门诊时，可以用 [Doctor Visit Checklist](../../handbook/playbooks/doctor-visit-checklist.md)。如果不知道该急诊、普通门诊、urgent care，还是该找哪个专科诊室，可以先看 [Care Entry And Specialist Navigation](../../handbook/playbooks/department-navigation-guide.md)。
...
- 上一章：[8. Common Specialty Problems 中文验收页](../part-2-body-risk-map/specialty-care-map.md)
- 下一章：[2. How To Prepare For A Medical Visit 中文验收页](doctor-visit-preparation.md)

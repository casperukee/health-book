...
<figure class="book-figure">
  <img src="../../../../en/book/assets/figures/fig-02-checkup-four-lenses.svg" alt="Checkup markers: read through four lenses">
</figure>
...
2. **把单次结果当长期趋势。** 一次异常不等于疾病，一次正常也不等于长期没风险。看趋势比看一次 flag 更重要。
...
具体怎么选，先看 [Before A Checkup](../../handbook/playbooks/checkup-planning-guide.md)。这页会把基础项、年龄/性别/解剖结构相关项和个人风险加项拆开讲。

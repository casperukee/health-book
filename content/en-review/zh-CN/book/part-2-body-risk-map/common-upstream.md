...
最典型的场景，是体检后临床人员说：“先改善生活方式，过一段时间复查。”
...
我更愿意把这件事叫作把趋势往回拉，而不是靠生活方式治疗某个病。它不替代临床人员，不替代药物，也不替代复诊；但在很多风险还没有变成严重后果之前，日常生活确实有一段可以介入的空间。
...
<figure class="book-figure">
  <img src="../../../../en/book/assets/figures/fig-15-common-upstream-defaults.svg" alt="Common upstream: five daily defaults">
</figure>
...
<figure class="book-figure">
  <img src="../../../../en/book/assets/figures/fig-18-activity-structure.svg" alt="Activity structure: build the floor before the program">
</figure>
...
<figure class="book-figure">
  <img src="../../../../en/book/assets/figures/fig-17-glucose-curve-meal-order.svg" alt="Meal order can make the glucose curve gentler">
</figure>
...
已经确诊糖尿病、痛风、高血压、肾病、心血管病，或者正在用降糖、降压、降脂、降尿酸、利尿剂、抗凝等药物的人，不要把饮食调整当成治疗替代品。怎么吃、怎么复查、是否需要药物和目标值，都要和临床人员协作。
...
反馈不需要很复杂。你可以只看几条线：体重和腰围有没有慢慢变化，血压有没有趋势，血糖或 A1C、血脂、尿酸按临床人员建议复查后有没有方向，睡眠和白天精力有没有改善，活动是否能维持，哪些场景最容易让自己失控。
...
- 相关工具：[Chronic Marker Log 中文验收页](../../handbook/templates/family-health-record.md#_2-chronic-marker-log)、[Before A Checkup 中文验收页](../../handbook/playbooks/checkup-planning-guide.md)、[Common Checkup Markers 中文验收页](../../handbook/playbooks/common-checkup-markers.md)

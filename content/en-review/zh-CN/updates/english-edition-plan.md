...
language: zh-CN
source_path: ../../../en/updates/english-edition-plan.md
...
1. 建立英文网页 foundation pack。
2. 在网站上 adaptation 核心主书章节和手册工具。
3. 做英文编辑审查和医学边界审查。
4. 稳定一个网页版本 checkpoint。
5. 再制作英文读书版发布包。
...
英文页面更新时，应在同一工作会话中更新对应中文验收页。

## 阶段顺序

Phase 0：重置英文版框架。

- 更新英文首页，说明英文版正在作为中文 `v1.0.0` 的 U.S.-first adaptation 重建；
- 更新英文主书目录，镜像中文 `v1.0.0` 结构并标清章节状态；
- 现有英文页在重写前仍视为 preview material；
- 英文术语稳定后更新 shared glossary。
...
- `common-checkup-markers.md`
- `family-health-record.md`

Phase 3：身体主风险线。

后续继续围绕代谢、心血管、睡眠、大脑心理、癌症、儿童青少年、专科问题和家庭健康系统推进。

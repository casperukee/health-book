...
对应英文页：[Playbooks](../../../../en/handbook/playbooks/README.md)

本页是英文 playbooks 目录的中文验收辅助。

## Playbooks

当家庭需要下一步行动时，使用这些页面。

如果已经出现危险信号，先从 [Red Flags](../../../../en/handbook/playbooks/red-flags.md) 开始，并在使用其他清单前先寻求合适照护。
...
| 场景 | 先打开 |
| --- | --- |
| 有人现在可能需要求助 | [Red Flags](../../../../en/handbook/playbooks/red-flags.md) |

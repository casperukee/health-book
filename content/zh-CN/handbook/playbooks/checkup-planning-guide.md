...
```text
我是普通筛查，还是带着症状、既往病或家族风险去查？
```

如果已经有胸痛、卒中样症状、严重气短、晕厥、异常出血、严重腹痛、意识改变或自伤风险，不要用体检拖延，先就医或急诊。
...
1. 先看有没有危险信号，有就按急事处理。
2. 标出异常项，但先不下诊断。
3. 看异常属于哪条线：血管、代谢、肾脏、肝胆、血液、炎症、肿瘤筛查，还是影像随访。
4. 把血压、血脂、血糖、A1C、尿酸、肾功能、体重和腰围放进趋势记录。
5. 如果明显异常、持续异常、多个指标一起异常，或看不懂下一步，用 [就医前问题清单](doctor-visit-checklist.md) 准备门诊。

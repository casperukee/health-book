...
如果出现胸痛胸闷、卒中样症状、严重呼吸困难、晕厥或意识改变、无法控制出血、突然剧烈疼痛、严重创伤、中毒、严重过敏、自伤自杀风险、孕产期危险信号，或感染后状态迅速变差，请回到 [危险信号：先分急缓，不要先搜病名](../medical-boundaries.md) 或 [危险信号速查](../../handbook/playbooks/red-flags.md)，优先就医或联系当地急救服务。
...
- [回到中文主书目录](../README.md)
- 上一章：[危险信号：先分急缓，不要先搜病名](../medical-boundaries.md)
- 下一章：[体检指标：不是判决书，而是风险语言](checkup-markers.md)

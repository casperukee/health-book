...
<div class="decision-grid">
  <section class="decision-card decision-card-blue">
    ...
    <h3>中年长期睡少，痴呆风险更高</h3>
    <p>NIH 介绍的一项长期人群研究提示，中年每晚睡眠 6 小时或更少，和后续痴呆风险升高有关。这里说的是长期风险关联，不是一次熬夜的后果。</p>
  </section>
  <section class="decision-card decision-card-green">
    <div class="decision-label">血管与代谢风险</div>
    <h3>血压、血糖、体重和心血管风险都会被牵动</h3>
  ...
  <section class="decision-card decision-card-yellow decision-card-wide">
    ...
    <h3>白天反应变慢、判断变差，更容易出错</h3>
    <p>睡眠不足会影响学习、专注、反应、情绪控制和决策。睡得差，白天更累；白天更累，活动更少、咖啡更多、情绪更紧，晚上又更难睡。</p>
  </section>
</div>

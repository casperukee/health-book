...
新增来源时，同步更新 `shared/source-registry.md`。
...
使用说明：这些资料用于校准“什么时候不能再靠阅读和观察”的边界。正文不应把它们改写成自我诊断表，也不应替代当地急救、急诊或医生分诊。
...
使用说明：这些资料用于校准健康寿命、功能能力、健康老龄化和慢病风险框架。正文不应承诺延寿，也不应把公共卫生建议改写成个体化处方。
...
使用说明：这些资料用于校准补剂的监管边界、证据边界、潜在相互作用和消费风险。正文不应逐一推荐产品，也不应把补剂写成治疗替代品。

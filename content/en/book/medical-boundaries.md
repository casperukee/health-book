...
<p class="chapter-subtitle">Chapter 1 · What The Body Is Saying: From Signals To Markers</p>
...
If you are already facing a concrete symptom and want a direct next-action table, you can first use [Symptom Action Guide](../handbook/playbooks/symptom-action-guide.md). This chapter explains the boundary principles behind it.
...
This is not a complete list. A fuller red-flag page is in [Red Flags](../handbook/playbooks/red-flags.md). If you want to sort common situations such as chest pain, fever, abdominal pain, falls, or emotional collapse, use [Symptom Action Guide](../handbook/playbooks/symptom-action-guide.md). Build one habit first: if you find yourself thinking "this person may not safely make it to tomorrow," "they may get worse on the way," or "I cannot move or watch them safely," do not keep reading as the way to decide.
...
<figure class="book-figure">
  <img src="./assets/figures/fig-13-triage-decision-tree-mobile.svg" alt="30-second next step: family care entry decision tree">
</figure>
...
Then put [Red Flags](../handbook/playbooks/red-flags.md) at the front of your family health record, and keep [Symptom Action Guide](../handbook/playbooks/symptom-action-guide.md) for the moments that do not look like emergencies but still leave you unsure whether waiting is safe.
...
- Next chapter: [2. Healthspan: Who Is Your Body Counting Down For?](part-1-healthspan-risk-and-markers/healthspan-and-risk-curve.md)

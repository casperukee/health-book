...
<figure class="book-figure">
  <img src="../assets/figures/fig-07-sleep-recovery-window.svg" alt="Sleep and recovery: look at night and day">
</figure>
...
If you are already preparing to buy sleep devices, tests, or supplements, first use the [Health Product Checklist](../../handbook/templates/health-product-checklist.md) to judge whether it is replacing the thing that actually needs to happen.
...
- Previous chapter: [3. Common Upstream: Pull Risk Back Before It Becomes Disease](common-upstream.md)
- Next chapter: [5. Brain And Mental Health: Start With Safety, Function, And Support](brain-and-mental-health.md)

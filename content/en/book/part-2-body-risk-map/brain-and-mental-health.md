...
# 5. Brain And Mental Health: Start With Safety, Function, And Support
...
<figure class="book-figure">
  <img src="../assets/figures/fig-08-brain-mental-four-questions.svg" alt="Brain and mental health: ask four things first">
</figure>
...
Write only two or three sentences each night. The point is not to prove who has a problem, but to let change be seen. If the person observed is a parent or older adult, put this card into the [Family Health Record And Chronic Marker Log](../../handbook/templates/family-health-record.md), and use it with the [Doctor Visit Checklist](../../handbook/playbooks/doctor-visit-checklist.md) before follow-up.
...
Start directly with: [CDC Stroke Signs and Symptoms](https://www.cdc.gov/stroke/signs-symptoms/index.html), [CDC Signs and Symptoms of Dementia](https://www.cdc.gov/alzheimers-dementia/signs-symptoms/index.html), [NIMH Depression](https://www.nimh.nih.gov/health/publications/depression), [NIMH Anxiety Disorders](https://www.nimh.nih.gov/health/topics/anxiety-disorders/index.shtml), [NIMH Suicide Prevention](https://www.nimh.nih.gov/health/topics/suicide-prevention), and [NIA Cognitive Health and Older Adults](https://www.nia.nih.gov/health/brain-health/cognitive-health-and-older-adults). More sources are in the [source registry](../../references/source-registry.md). This book's evidence rules are in the [evidence policy](../../references/evidence-policy.md).

...
Devices, tests, and longevity products may not look like traditional supplements, but before buying, you can still run them through the same [health product checklist](../../handbook/templates/health-product-checklist.md).
...
<div class="decision-grid">
  <section class="decision-card decision-card-blue">
    <span class="decision-label">Can measure</span>
    <h3>Does not mean it measured what truly matters</h3>
    <p>Sensors, algorithms, questionnaires, cameras, home sampling, and laboratory tests are not the same thing. A number appearing in an app does not automatically make it a medically important number.</p>
  </section>
  <section class="decision-card decision-card-yellow">
    <span class="decision-label">Measures accurately</span>
    <h3>Does not mean it can guide medical decisions</h3>
    <p>Some numbers are useful for trends, not diagnosis. Some tests may be accurate in a lab but hard for ordinary people to interpret in their own context.</p>
  </section>
  <section class="decision-card decision-card-green">
    <span class="decision-label">Useful</span>
    <h3>Does not mean everyone should buy it now</h3>
    <p>Value for a specific population, disease, and clinician-guided situation does not automatically become "everyone should buy one."</p>
  </section>
  <section class="decision-card decision-card-red">
    <span class="decision-label">Worth it</span>
    <h3>Depends on what it replaces</h3>
    <p>If a tool helps you sleep earlier, move, record, and follow up, it may be worthwhile. If it makes you anxious, adds tests, delays care, or changes medication, it is no longer ordinary spending.</p>
  </section>
</div>
...
<div class="decision-grid">
  <section class="decision-card decision-card-green">
    <span class="decision-label">Can support</span>
    <h3>Leads to low-risk action</h3>
    <p>Price is manageable, it does not replace medical care, it does not collect excessive sensitive information, and results are used only to watch trends and prompt low-risk action.</p>
  </section>
  <section class="decision-card decision-card-yellow">
    <span class="decision-label">Ask a professional first</span>
    <h3>May affect medical decisions</h3>
    <p>Results may affect medication, screening, diagnosis, surgery, pregnancy planning, chronic disease management, or the user is an older adult, pregnant person, child, cancer patient, or complex medication user.</p>
  </section>
  <section class="decision-card decision-card-blue">
    <span class="decision-label">Delay first</span>
    <h3>Do not buy immediately while anxious</h3>
    <p>Evidence is unclear, price is high, promises are large, next steps are vague, privacy information is extensive, or you mainly want to buy because you are anxious. Wait 24 hours.</p>
  </section>
  <section class="decision-card decision-card-red">
...
Moving the family out of the sales rhythm matters more than winning or losing on the spot.
...
If the product also involves supplements, dietary products, or herbs, read [1. Supplement Evidence Traps: "Trying It" Is Not Always Harmless](supplement-evidence-traps.md) as well.
...
- Previous chapter: [1. Supplement Evidence Traps: "Trying It" Is Not Always Harmless](supplement-evidence-traps.md)
- Next chapter: [3. Health News, New Studies, And Short Videos: The More You Want To Act Immediately, The More You Should Slow Down](reading-health-news.md)

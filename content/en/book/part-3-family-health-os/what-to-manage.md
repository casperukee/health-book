...
zh_path: ../../../zh-CN/book/part-3-family-health-os/what-to-manage.md
review_path: ../../../en-review/zh-CN/book/part-3-family-health-os/what-to-manage.md
...
Your father says on the phone that his chest feels a little tight, then adds, "I will rest and it will pass." Your mother finds a checkup report from six months ago and asks whether that arrow still needs follow-up. The child says for the third time this week that their stomach hurts and they do not want to go to school. Your partner asks whether there is any of the medicine from last time left at home. Meanwhile the family group chat receives a relative's liver-protection product link.
...
## First Take Health Out Of "Are There Arrows?"

When many people say health management, the first image in their mind is a checkup report.

No arrows, and everyone relaxes; many arrows, and the body feels broken. That reaction is natural, but it cannot carry all health judgment.
...
Second, is risk accumulating? Blood pressure, glucose, lipids, weight, waist, sleep, smoking and alcohol, activity, and stress may not cause trouble today, but they change the future risk curve.

Third, has the abnormality been handed off? If a report has arrows, symptoms keep recurring, a clinician recommended follow-up, or medicines changed, did anyone record it, follow up, and ask the next step clearly?

This is also why family health management cannot be the same as an annual checkup. The checkup is an important clue, but still only a clue. What often changes the family's health state is whether the family catches the clue afterward, whether daily defaults change, and whether danger boundaries are clarified in advance.

## Four Things Families Most Often Manage Wrong

First, treating health management as saving articles.

No matter how many health articles are forwarded in the family group chat, that does not mean the family knows who has which conditions, which medicines they take, what cannot wait, or where follow-up is. Articles can inform judgment, but they cannot replace a fact packet.
...
Blood pressure, glucose, lipids, uric acid, and weight are important. But so are sleeping, walking, eating, remembering, taking medicines, and living independently. If numbers cannot turn into next steps, they become another source of anxiety.

Fourth, waiting until something happens to organize.

When records are truly needed, the family is usually already panicking. Searching for reports at the emergency department door, asking medicine names before admission, and debating who will stay with the patient before signing papers all amplify fear.
...
<figure class="book-figure">
  <img src="../assets/figures/fig-06-family-health-four-things.svg" alt="Family health management: manage four things first">
</figure>

Facts are not opinions or guesses. They include: when symptoms started and how they changed; prior diseases, surgeries, and hospitalizations; current prescription medicines, over-the-counter medicines, supplements, and herbs; drug or food allergies; and where recent checkups, labs, imaging, pathology, and discharge summaries are.
...
Most of the value in family health does not come from one luxury checkup or one amazing project. It comes from small things that happen repeatedly every day.
...
The home's default meal is a little lower in salt and oil. A ten-minute walk after dinner is the default. A wind-down period before bed is the default. Secondhand smoke does not enter the home. The medicine cabinet is cleared periodically. Checkup reports go in the same place by default. Photos of older adults' long-term medicines are kept by default. A child's vaccination record is findable by default.

None of these actions is dramatic, but they reduce long-term household friction.

Sustainable family health is not the whole family suddenly vowing to change. It is gradually adjusting a few wrong defaults. Less "starting tomorrow we change completely," more "today put the report into the fixed folder," "this week clear expired medicines from the cabinet," "this month make after-meal walking feel normal."
...
- allergies;
- current prescription medicines, over-the-counter medicines, supplements, and herbs;
- recent important tests, checkup reports, imaging, and discharge summaries;
- usual hospitals, familiar clinicians, or departments;
- next recheck or follow-up plan;
- where records are stored.

HealthIT.gov's patient and caregiver guidance on health records reminds readers that health records usually include medicines, treatments, tests, immunizations, and clinician visits. Their value is not only "keeping a file," but also sharing, coordinating, checking, and confirming. A family health card does this small job: it makes key records available when needed.
...
Enter the appropriate care doorway
...
Before entering the room, symptoms are unclear, medicine names are unclear, and reports cannot be found. After leaving, test purpose, medication changes, follow-up time, and "when to come back early" remain only in memory.
...
- how to carry out medicine or handling instructions, and what abnormalities should lead to contacting the clinician;
- when to follow up;
...
- whether the medicine cabinet, vaccines, checkups, follow-up, or reports have pending tasks;
...
Create one health card for one family member: emergency contacts, important medical history, allergies, current medicines, recent important tests, and where records are stored.

Put long-term medicines, supplements, allergies, and the most recent important report in one place.
...
- Next chapter: [2. Preparing For A Doctor Visit: Bring Facts Into The Room](doctor-visit-preparation.md)

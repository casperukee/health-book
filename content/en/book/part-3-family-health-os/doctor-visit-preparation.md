...
A clinician asks, "When did this start?" A family member says, "It has been going on for a while."
A clinician asks, "What medications are you taking now?" An older parent says, "The white pill, maybe once a day, maybe twice."
A clinician asks, "Have you had this checked before?" Everyone starts searching photos, messages, and folders.
Near the end of the visit, the patient finally remembers, "What I really wanted to ask is whether this could be serious."
...
<div class="decision-grid">
  <section class="decision-card decision-card-blue">
    <span class="decision-label">Packet 1</span>
    <h3>Symptom timeline</h3>
    <p>When it started, how it changed, what makes it better or worse, what came with it, and how it affects function.</p>
  </section>
  <section class="decision-card decision-card-green">
    <span class="decision-label">Packet 2</span>
    <h3>Prior records</h3>
    <p>Related labs, imaging, pathology, discharge summaries, prior diagnoses, prior plans, and follow-up records.</p>
  </section>
  ...
  <section class="decision-card decision-card-rose">
    ...
    <p>The three questions you most want the clinician to answer, written in priority order.</p>
  </section>
</div>
...
This opening does not need to be perfect. Its value is not sounding medically fluent. Its value is letting the clinician know the main problem, the direction of change, and what is disrupting daily life.
...
- Previous chapter: [1. What A Family Health System Actually Manages: Facts And Boundaries, Not People](what-to-manage.md)
- Next chapter: [3. Talking With Parents About Health: Do Not Turn Care Into Control](talking-with-parents.md)
